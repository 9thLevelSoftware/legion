...
6. VALIDATE SCHEMA
   ...
   - Run all 8 validation checks:
     1. Name uniqueness (grep across agency-agents/)
...
7. GENERATE FILES
   ...
   a. File Generation:
      - Construct path: agency-agents/{division}/{agent-name}.md
      - If custom division: create agency-agents/custom/ if needed
...
8. CONFIRM AND COMMIT
   ...
   - Create a git commit:
     ```
     git add agency-agents/{division}/{agent-name}.md .claude/skills/agency/agent-registry.md
