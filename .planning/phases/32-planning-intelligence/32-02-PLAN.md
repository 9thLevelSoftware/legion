...
must_haves:
  truths:
    - >-
      phase-decomposer has a 'Competing Architecture Proposals' section
      documenting 3 philosophy archetypes
    - >-
      plan command has a step 3.5 that spawns 2-3 agents with labeled
      philosophies before decomposition
    - 'Users can select an approach, request a hybrid, or skip for simple phases'
    - >-
      The competing proposals step defaults to skip — opt-in, not opt-out.
      Threshold: 3+ requirements AND architectural choices
  artifacts:
    - path: skills/phase-decomposer/SKILL.md
      provides: >-
        Competing Architecture Proposals section with philosophy definitions and
        presentation format
      min_lines: 550
  ...
  key_links:
    - from: commands/plan.md
      ...
      via: >-
        Step 3.5 references phase-decomposer's Competing Architecture Proposals
        section
