...
must_haves:
  truths:
    - >-
      Polymath researches domain via available tools before asking user
      questions
    - >-
      Polymath detects knowledge gaps and offers structured clarification
      options
    - >-
      Exploration produces either crystallized PROJECT.md input or explicit
      continue-exploring decision
