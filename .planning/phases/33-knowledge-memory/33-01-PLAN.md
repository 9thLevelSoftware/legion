...
must_haves:
  truths:
    - >-
      memory-manager SKILL.md contains a PATTERNS.md File Format section with
      table schema (ID, Date, Pattern, Context, Reuse Criteria, Tags)
    - >-
      memory-manager SKILL.md contains an ERRORS.md File Format section with
      table schema (ID, Date, Error Signature, Fix, Agent, Tags)
    - >-
      memory-manager SKILL.md contains Store Pattern and Store Error operations
      with step-by-step instructions
    - >-
      memory-manager SKILL.md contains Recall Patterns and Recall Errors
      operations
    - >-
      workflow-common State File Locations includes Memory Patterns and Memory
      Errors rows
    - >-
      workflow-common Memory Conventions includes PATTERNS.md and ERRORS.md in
      paths table and integration points
    - >-
      All three memory files (OUTCOMES, PATTERNS, ERRORS) follow the same
