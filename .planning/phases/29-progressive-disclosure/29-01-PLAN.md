...
must_haves:
  truths:
    - >-
      All 17 SKILL.md files have YAML frontmatter containing name, triggers,
      token_cost, and summary fields
    - Each summary field is ≤100 tokens (roughly ≤400 characters)
    - >-
      workflow-common contains a 'Skill Loading Protocol' section with
      load-on-activate instructions
