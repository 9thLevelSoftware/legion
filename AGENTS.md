...
A multi-CLI plugin for orchestrating 48 AI specialist personalities as a coordinated legion. Works with Codex, OpenAI Codex CLI, Cursor, GitHub Copilot CLI, Google Gemini CLI, Kiro CLI, Windsurf, OpenCode, and Aider.
